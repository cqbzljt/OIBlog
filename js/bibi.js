...
let items = []
let page = 1
let Url = 'https://kkapi-gamma.vercel.app/api/ispeak?author=62dc015ea88c248780491e70&page=' // 修改api，记得带参数page
...
function getNew() {
    ...
    bibi.innerHTML += '<div id="loading"><img src="https://bu.dusays.com/2021/03/04/d2d5e983e2961.gif" alt="loading"></div>' // loading图片可以f12在我网站源码下载，也可以使用其他图片。
